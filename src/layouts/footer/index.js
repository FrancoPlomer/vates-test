    ...
    <div className="lay">
        <section className="row footer-header">
            ...
            <section className="col-12 col-desksm-4 col-desk-3 footer-header__redes">
                <a href="https://www.facebook.com/lanacion" target="_blank"  rel="noreferrer"><img src={ require('assets/img/fb.svg').default } alt="fb" className="icon-facebook"/></a>
                <a href="https://twitter.com/LANACION" target="_blank"  rel="noreferrer"><img src={ require('assets/img/tw.svg').default } alt="tw" className="icon-twitter"/></a>
                <a href="https://www.instagram.com/lanacioncom/" target="_blank "  rel="noreferrer"><img src={ require('assets/img/ig.svg').default } alt="ig" className="icon-instagram"/></a>
                <a href="http://servicios.lanacion.com.ar/herramientas/rss/ayuda" target="_blank"  rel="noreferrer"><img src={ require('assets/img/wifi.svg').default } alt="wifi" className="icon-rss"/></a>
            </section>
            <section className="col-12 col-desksm-4 col-desk-3 footer-header__app">
                <a href="https://play.google.com/store/apps/details?id=app.lanacion.activity&amp;hl=es_419" target="_blank" className="app_play"  rel="noreferrer">
                ...
                <section className="col-desksm-6 col-deskxl-5">
                    <section className="row ">
                        <section className="col-desksm-12 col-deskxl-6 link">
                            <a href="https://policies.google.com/terms?hl=es-419" target="_blank" className="condition"  rel="noreferrer">Condiciones</a>
                        </section>
                        <section className="col-desksm-12 col-deskxl-6 link">
                            <a href="https://policies.google.com/privacy?hl=es-419" target="_blank" className="private"  rel="noreferrer">Privacidad</a>
                        </section>
                    </section>
                </section>
            </section>
